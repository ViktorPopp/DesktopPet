...
# Set pet's height for alignment at the bottom
pet_height = 100  # Adjust this value based on your pet's actual height
...
def update(cycle,check,event_number,x):
    y = screen_height - pet_height  # Fixed vertical position at the bottom
...
# Ensure window stays on top of all other windows, including the taskbar
